            ...
            <div class="col-md-4">
                <div class="input-group">
                    ...
                    echo $this->form_complete->create_element(array(
                        ...
                        'type' => 'email',
                        'value' => $usuario['email'],
                        'attributes' => array('readonly' => ' ', 'name' => 'email', 'class' => 'form-control')));
                    ?>
                </div>
            </div>
            <div class="col-md-6">
                    ...
                    <div class="col-md-8">
                        <div class="input-group">
                            ...
                            echo $this->form_complete->create_element(array(
                                ...
                                'attributes' => array('readonly' => ' ', 'name' => 'departamento_texto', 'class' => 'form-control', 'autocomplete' => 'off')));
                            ?>
            ...
            <div class="col-md-4">
                <div class="input-group">
                    ...
                    echo $this->form_complete->create_element(array(
                        ...
                        'attributes' => array('readonly' => ' ', 'name' => 'categoria_texto', 'class' => 'form-control', 'autocomplete' => 'off')));
                    ?>

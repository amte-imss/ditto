...
<div class="row">
    ...
    <div class="col-md-12 col-sm-12 mb">
        ...
        <div class="col-md-6 goleft">
            <p><label class="pull-left bold-label"><?php echo $string_value['folio_censo']; ?></label>
...
//                echo $this->form_complete->create_element(array('id' => 'idc', 'type' => 'hidden', 'value' => $file));
                    ...
                    case 'date'://Tipo de campo file
                        ...
                        <div class="col-md-6 goleft">
                            <p><label class=" pull-left bold-label"><?php echo $value['lb_campo']; ?></label>
                                <?php echo get_date_formato($value['respuesta_valor']); ?>
                            </p>
        ...
        if (isset($detalle_censo['id_censo']) || !empty($detalle_censo['id_censo'])) { //En caso de tener asociado archivo, se muestra link
            ?>
            <div class="col-md-6 goleft">
                <p><label class="pull-left bold-label"><?php echo $string_value['lbl_texto_comprobante']; ?></label>
